...
def gpt_prompt(user_input):
    base_prompt = f"""
    너는 전문적인 '간편식 추천 및 비교'를 제공하는 스마트 챗봇입니다.
...
selected_chatbot = st.selectbox(
    "원하는 챗봇을 선택하세요.",
    options=["GPT를 활용한 간편식 추천 및 비교", "Gemini를 활용한 간편식 추천 및 비교", "GPT를 활용한 간편식 레시피 조합 추천", "Gemini를 활용한 간편식 레시피 조합 추천"],
    placeholder="챗봇을 선택하세요.",
    help="선택한 LLM 모델에 따라 다른 챗봇을 제공합니다."
)

if selected_chatbot == "GPT를 활용한 간편식 추천 및 비교":
    colored_header(
        label='GPT를 활용한 간편식 추천 및 비교',
        description=None,
        color_name="green-70",
    )
...
elif selected_chatbot == "GPT를 활용한 간편식 레시피 조합 추천":
    colored_header(
        label='GPT를 활용한 간편식 레시피 조합 추천',
        description=None,
        color_name="green-70",
    )
...
elif selected_chatbot == "Gemini를 활용한 간편식 추천 및 비교":
    colored_header(
        label='Gemini를 활용한 간편식 추천 및 비교',
        description=None,
        color_name="blue-70",
    )
    # 세션 변수 체크
